...
public class TurkTvYonlendirCategoriesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_turk_tv_yonlendir_categories);
        ...
        homeButton.setOnClickListener(v -> {
            ...
            Intent homeIntent = new Intent(TurkTvYonlendirCategoriesActivity.this, MainActivity.class);
    ...
    private void fetchData() {
        ...
        Call<List<YerelTvYonlendirCategoryModel>> req = ManagerAll.getInstance().yerelTurkTvCategoryYonlendirFetch();
            ...
            public void onResponse(Call<List<YerelTvYonlendirCategoryModel>> call, Response<List<YerelTvYonlendirCategoryModel>> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (main_list != null && !main_list.isEmpty()) {
                        adapter = new YerelTvYonlendirCategoryAdapter(main_list, TurkTvYonlendirCategoriesActivity.this);
...
//        Toast.makeText(this, "No internet connection. Please check your network settings.", Toast.LENGTH_LONG).show();
    ...
    private void redirectYonlendir() {
        ...
        Intent intent = new Intent(TurkTvYonlendirCategoriesActivity.this, MainActivity.class);
