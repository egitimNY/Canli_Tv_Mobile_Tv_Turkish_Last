...
public class TurkTvDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_turk_tv_details);
        ...
        player.addListener(new Player.Listener() {
            ...
            public void onPlaybackStateChanged(int state) {
                if(state == Player.STATE_READY){
                    ...
                    Toast.makeText(TurkTvDetailsActivity.this, "Şu an için TV kanalı yüklenemiyor, lütfen daha sonra tekrar deneyin!", Toast.LENGTH_LONG).show();
                    finish();
                    /*
