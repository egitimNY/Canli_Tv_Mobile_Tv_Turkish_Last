...
public class YtbExtraTvYonlendirCountriesDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        homeButton.setOnClickListener(v -> {
            ...
            Intent homeIntent = new Intent(YtbExtraTvYonlendirCountriesDetailsActivity.this, MainActivity.class);
            startActivity(homeIntent);
            finish(); // Close the current activity
        });

        recyclerView = findViewById(R.id.ytbExtraYonlendirCountriesDetailsRecyclerView); // Initialize the RecyclerView
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        String selectedCategory = getIntent().getStringExtra("ytbExtrCountryYonlendir");
    ...
    private void fetchData(String selectedCategory) {
        Call<List<YtbExtraTvYonlendirModel>> req = ManagerAll.getInstance().getYtbExtraTvByCountryYonlendirFetch(selectedCategory);
            ...
            public void onResponse(Call<List<YtbExtraTvYonlendirModel>> call, Response<List<YtbExtraTvYonlendirModel>> response) {
                if (response.isSuccessful()) {
                    ...
                    if (main_list != null && !main_list.isEmpty()) {
                        adapter = new YtbExtraTvYonlendirAdapter(main_list, YtbExtraTvYonlendirCountriesDetailsActivity.this);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(this, YtbExtraTvYonlendirCountriesActivity.class);
        startActivity(intent);
        finish(); // Close the current activity
