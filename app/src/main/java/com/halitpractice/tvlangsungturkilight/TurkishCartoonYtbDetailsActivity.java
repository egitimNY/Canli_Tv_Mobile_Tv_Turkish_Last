...
public class TurkishCartoonYtbDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_india_cartoon_ytb_details);


        backButton = findViewById(R.id.back_button_cartoon);
...
//                finish();
        ...
        redirectButton = findViewById(R.id.redirectButtonCartoon);
        sameVideoButton = findViewById(R.id.sameVideoButtonCartoon); // Find the same video button
        switchOrientationButton = findViewById(R.id.switch_orientation_button_cartoon);
        messageTextView = findViewById(R.id.messageTextViewCartoon);
        ...
        youTubePlayerView = findViewById(R.id.youtube_player_view_cartoon);
        getLifecycle().addObserver(youTubePlayerView);

        String selectedVideoId = getIntent().getStringExtra("videoId");
        ...
        mAdView = findViewById(R.id.adViewIndiaLiveTvCartoonYoutubeDetails);
        AdRequest adRequest = new AdRequest.Builder().build();
        mAdView.loadAd(adRequest);

        closedBtn = findViewById(R.id.closeBtnIndiaLiveTvCartoonYoutubeDetails);
