...
import com.halitpractice.tvlangsungturkilight.services.YtbExtraTvCategoriesDetailsDataCache;
...
public class YtbExtraTvCategoriesDetailsActivity extends AppCompatActivity {
    ...
    private YtbExtraTvCategoriesDetailsDataCache dataCache;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ytb_extra_tv_categories_details);
        ...
        recyclerView = findViewById(R.id.ytbExtraTvCategoryDetailsRecycler); // Initialize the RecyclerView
        ...
        */
        ...
        AdView mAdView = findViewById(R.id.adViewYtbExtraCategoriesDetails);
        AdRequest adRequest = new AdRequest.Builder().build();
        mAdView.loadAd(adRequest);

        ImageView closedBtn = findViewById(R.id.closeBtnYtbExtraCategoriesDetails);
    ...
    private void fetchData(String selectedCategory) {
        ...
        if (cachedData != null && !cachedData.isEmpty()) {
            ...
            Call<List<YtbExtraTvModel>> req = ManagerAll.getInstance().ytbExtraTvCategoryDetailsFetch(selectedCategory);
    ...
    private void updateUIWithCachedData(List<YtbExtraTvModel> cachedData) {
        if (cachedData != null && !cachedData.isEmpty()) {
            adapter = new YtbExtraTvAdapter(cachedData, YtbExtraTvCategoriesDetailsActivity.this);
...
//        Toast.makeText(this, "İnternet bağlantısı yok. Lütfen ağ ayarlarınızı kontrol edin.", Toast.LENGTH_LONG).show();
    ...
    private void redirectYonlendir() {
        ...
        Intent intent = new Intent(YtbExtraTvCategoriesDetailsActivity.this, YtbExtraTvYonlendirCategoriesDetailsActivity.class);
