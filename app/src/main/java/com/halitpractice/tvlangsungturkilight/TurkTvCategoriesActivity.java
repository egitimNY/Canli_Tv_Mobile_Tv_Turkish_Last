...
public class TurkTvCategoriesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_turk_tv_categories);
        ...
        homeButton.setOnClickListener(v -> {
            ...
            Intent homeIntent = new Intent(TurkTvCategoriesActivity.this, MainActivity.class);
        ...
        AdView mAdView = findViewById(R.id.adViewIndiaYerelTvCategories);
        AdRequest adRequest = new AdRequest.Builder().build();
        mAdView.loadAd(adRequest);

        /*
        ImageView closedBtn = findViewById(R.id.closeBtnYerelTvCategories);
...
//        fetchData();
    ...
    private void updateUIWithCachedData(List<YerelTvCategoryModel> cachedData) {
        if (cachedData != null && !cachedData.isEmpty()) {
            adapter = new YerelTvCategoryAdapter(cachedData, TurkTvCategoriesActivity.this);
