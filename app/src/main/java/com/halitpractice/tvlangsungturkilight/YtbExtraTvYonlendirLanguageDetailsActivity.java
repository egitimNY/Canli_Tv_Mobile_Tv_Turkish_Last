...
public class YtbExtraTvYonlendirLanguageDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ytb_extra_tv_yonlendir_language_details);
        ...
        homeButton.setOnClickListener(v -> {
            ...
            Intent homeIntent = new Intent(YtbExtraTvYonlendirLanguageDetailsActivity.this, MainActivity.class);
            startActivity(homeIntent);
            finish(); // Close the current activity
        });

        recyclerView = findViewById(R.id.ytbExtraTvYonlendirLanguageDetailsRecyclerView); // Initialize the RecyclerView
        ...
        AdView mAdView = findViewById(R.id.adViewYtbExtraTvYonlendirLanguageDetails);
        AdRequest adRequest = new AdRequest.Builder().build();
        mAdView.loadAd(adRequest);
        /*
        ImageView closedBtn = findViewById(R.id.closeBtnYtbExtraTvYonlendirLanguageDetails);
    ...
    private void fetchData(String selectedCategory) {
        Call<List<YtbExtraTvYonlendirModel>> req = ManagerAll.getInstance().ytbExtraTvLanguageDetailsYonlendirFetch(selectedCategory);
            ...
            public void onResponse(Call<List<YtbExtraTvYonlendirModel>> call, Response<List<YtbExtraTvYonlendirModel>> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (main_list != null && !main_list.isEmpty()) {
                        adapter = new YtbExtraTvYonlendirAdapter(main_list, YtbExtraTvYonlendirLanguageDetailsActivity.this);
...
//            Toast.makeText(this, "There is no internet connection. Please check your network settings.", Toast.LENGTH_LONG).show();
    ...
    private void redirectYonlendir() {
        ...
        Intent intent = new Intent(YtbExtraTvYonlendirLanguageDetailsActivity.this, MainActivity.class);
        startActivity(intent);
    }

    @Override
    public void onBackPressed() {
        Intent intent = new Intent(this, YtbExtraTvYonlendirLanguageActivity.class);
        startActivity(intent);
        finish(); // Close the current activity
