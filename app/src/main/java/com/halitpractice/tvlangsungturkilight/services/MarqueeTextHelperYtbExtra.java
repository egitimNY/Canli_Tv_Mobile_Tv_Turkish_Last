...
public class MarqueeTextHelperYtbExtra {

    public static void fetchAndDisplayMarqueeTextYtbExtra(TextView marqueeTextView) {
        Call<MarqueeTextModel> req = ManagerAll.getInstance().getMarqueTextYtbExtra();
