...
public class MarqueeTextHelperDunyaTv {

    public static void fetchAndDisplayMarqueeTextDunyaTv(TextView marqueeTextView) {
        Call<MarqueeTextModel> req = ManagerAll.getInstance().getMarqueTextDunyaTv();
