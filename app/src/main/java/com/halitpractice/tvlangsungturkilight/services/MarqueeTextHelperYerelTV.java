...
public class MarqueeTextHelperYerelTV {

    public static void fetchAndDisplayMarqueeTextYerelTv(TextView marqueeTextView) {
        Call<MarqueeTextModel> req = ManagerAll.getInstance().getMarqueTextYerelTv();
