...
public class MarqueeTextHelperUyariDisclaimer {

    public static void fetchAndDisplayMarqueeTextUyariDisclaimer(TextView marqueeTextView) {
        Call<MarqueeTextModel> req = ManagerAll.getInstance().getMarqueTextUyariDisclaimer();
