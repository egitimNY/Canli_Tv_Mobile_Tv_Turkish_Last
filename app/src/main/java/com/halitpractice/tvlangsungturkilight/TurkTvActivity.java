...
public class TurkTvActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_turk_tv);
        ...
        MarqueeTextHelperYerelTV.fetchAndDisplayMarqueeTextYerelTv(marqueeTextView);
