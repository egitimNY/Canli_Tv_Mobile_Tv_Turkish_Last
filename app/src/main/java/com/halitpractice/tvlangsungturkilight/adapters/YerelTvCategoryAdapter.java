...
import com.halitpractice.tvlangsungturkilight.YerelTvCategoriesDetailsActivity;
import com.halitpractice.tvlangsungturkilight.models.YerelTvCategoryModel;
import com.squareup.picasso.Picasso;

import java.util.List;

public class YerelTvCategoryAdapter extends RecyclerView.Adapter<YerelTvCategoryAdapter.MyViewHolder> {
    List<YerelTvCategoryModel> my_list;
    Context context;

    public YerelTvCategoryAdapter(List<YerelTvCategoryModel> my_list, Context context) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> {
            Intent i = new Intent(v.getContext(), YerelTvCategoriesDetailsActivity.class);
