...
import com.halitpractice.tvlangsungturkilight.activities.DunyaTvCategoriesDetailsActivity;
import com.halitpractice.tvlangsungturkilight.models.DunyaTvCategoryModel;
import com.squareup.picasso.Picasso;

import java.util.List;

public class DunyaTvCategoryAdapter extends RecyclerView.Adapter<DunyaTvCategoryAdapter.MyViewHolder> {
    List<DunyaTvCategoryModel> my_list;
    Context context;

    public DunyaTvCategoryAdapter(List<DunyaTvCategoryModel> my_list, Context context) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> {
            Intent i = new Intent(v.getContext(), DunyaTvCategoriesDetailsActivity.class);
