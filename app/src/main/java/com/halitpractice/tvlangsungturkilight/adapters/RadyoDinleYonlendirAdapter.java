...
public class RadyoDinleYonlendirAdapter extends RecyclerView.Adapter<RadyoDinleYonlendirAdapter.MyViewHolder> {
    private List<RadyoDinleYonlendirModel> my_list;
    private Context context;
    private int clickCount = 0; // Track the number of item clicks
    private InterstitialAd mInterstitialAd;

    public RadyoDinleYonlendirAdapter(List<RadyoDinleYonlendirModel> my_list, Context context) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        final RadyoDinleYonlendirModel radyoDinleYonlendirModel = my_list.get(position);
        holder.name.setText(radyoDinleYonlendirModel.getChannelname());

        // Load the image with Picasso or any other image loading library
        if (radyoDinleYonlendirModel.getImage() != null && !radyoDinleYonlendirModel.getImage().isEmpty()) {
            Picasso.get().load(radyoDinleYonlendirModel.getImage())
        ...
        holder.itemView.setOnClickListener(v -> {
            ...
            if (clickCount >= 1) {
                ...
                showInterstitialAd(radyoDinleYonlendirModel);
                ...
                openChannelInChromeCustomTab(radyoDinleYonlendirModel.getVideoid());
            }
        });
    ...
    private void showInterstitialAd(RadyoDinleYonlendirModel model) {
