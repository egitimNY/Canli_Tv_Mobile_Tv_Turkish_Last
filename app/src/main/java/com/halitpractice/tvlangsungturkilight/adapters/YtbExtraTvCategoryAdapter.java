...
import com.halitpractice.tvlangsungturkilight.YtbExtraTvCategoriesDetailsActivity;
import com.halitpractice.tvlangsungturkilight.models.YtbExtraTvCategoryModel;
import com.squareup.picasso.Picasso;

import java.util.List;

public class YtbExtraTvCategoryAdapter extends RecyclerView.Adapter<YtbExtraTvCategoryAdapter.MyViewHolder> {
    List<YtbExtraTvCategoryModel> my_list;
    Context context;

    public YtbExtraTvCategoryAdapter(List<YtbExtraTvCategoryModel> my_list, Context context) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> {
            Intent i = new Intent(v.getContext(), YtbExtraTvCategoriesDetailsActivity.class);
