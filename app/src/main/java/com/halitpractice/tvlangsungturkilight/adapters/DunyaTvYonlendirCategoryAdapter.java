...
import com.halitpractice.tvlangsungturkilight.activities.DunyaTvYonlendirCategoriesDetailsActivity;
...
public class DunyaTvYonlendirCategoryAdapter extends RecyclerView.Adapter<DunyaTvYonlendirCategoryAdapter.MyViewHolder> {
    List<YerelTvYonlendirCategoryModel> my_list;
    Context context;

    public DunyaTvYonlendirCategoryAdapter(List<YerelTvYonlendirCategoryModel> my_list, Context context) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> {
            Intent i = new Intent(v.getContext(), DunyaTvYonlendirCategoriesDetailsActivity.class);
