...
public class YerelTvYonlendirCategoryAdapter extends RecyclerView.Adapter<YerelTvYonlendirCategoryAdapter.MyViewHolder> {
    List<YerelTvYonlendirCategoryModel> my_list;
    Context context;

    public YerelTvYonlendirCategoryAdapter(List<YerelTvYonlendirCategoryModel> my_list, Context context) {
