...
public class YtbExtraTvCountriesDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        homeButton.setOnClickListener(v -> {
            ...
            Intent homeIntent = new Intent(YtbExtraTvCountriesDetailsActivity.this, MainActivity.class);
            startActivity(homeIntent);
            finish(); // Close the current activity
        });

        progressBar = findViewById(R.id.ytbExtraTvCountryDetailsProgressBar); // Initialize the ProgressBar
        progressBar.setVisibility(View.GONE); // Initially, set it to VISIBLE

        recyclerView = findViewById(R.id.ytbExtraTvCountriesDetailsRecycler); // Initialize the RecyclerView
        ...
        */
        ...
        AdView mAdView = findViewById(R.id.adViewYtbExtraCountriesDetails);
    ...
    private void fetchData(String selectedCategory) {
        ...
        if (cachedData != null && !cachedData.isEmpty()) {
            ...
            Call<List<YtbExtraTvModel>> req = ManagerAll.getInstance().ytbExtraTvCountriesDetailsFetch(selectedCategory);
    ...
    private void updateUIWithCachedData(List<YtbExtraTvModel> cachedData) {
        if (cachedData != null && !cachedData.isEmpty()) {
            adapter = new YtbExtraTvAdapter(cachedData, YtbExtraTvCountriesDetailsActivity.this);
