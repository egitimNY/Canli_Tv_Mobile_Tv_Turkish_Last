...
import com.halitpractice.tvlangsungturkilight.services.YtbExtraTvLanguageDetailsDataCache;
...
public class YtbExtraTvLanguageDetailsActivity extends AppCompatActivity {
    ...
    private YtbExtraTvLanguageDetailsDataCache dataCache;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ytb_extra_tv_language_details);
        ...
        homeButton.setOnClickListener(v -> {
            ...
            Intent homeIntent = new Intent(YtbExtraTvLanguageDetailsActivity.this, MainActivity.class);
            startActivity(homeIntent);
            finish(); // Close the current activity
        });

        progressBar = findViewById(R.id.ytbExtraTvLanguageDetailsProgressBar); // Initialize the ProgressBar
        progressBar.setVisibility(View.GONE); // Initially, set it to VISIBLE

        recyclerView = findViewById(R.id.ytbExtraTvLanguageDetailsRecycler); // Initialize the RecyclerView
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        String selectedCategory = getIntent().getStringExtra("ytbExtraTvCategory");
        ...
        */
        ...
        dataCache = YtbExtraTvLanguageDetailsDataCache.getInstance();
        ...
        AdView mAdView = findViewById(R.id.adViewYtbExtraLanguageDetails);
        AdRequest adRequest = new AdRequest.Builder().build();
        mAdView.loadAd(adRequest);
        /*
        ImageView closedBtn = findViewById(R.id.closeBtnYtbExtraLanguageDetails);
    ...
    private void fetchData(String selectedCategory) {
        ...
        if (cachedData != null && !cachedData.isEmpty()) {
            ...
            Call<List<YtbExtraTvModel>> req = ManagerAll.getInstance().ytbExtraTvLanguageDetailsFetch(selectedCategory);
            req.enqueue(new Callback<List<YtbExtraTvModel>>() {
                ...
                public void onResponse(Call<List<YtbExtraTvModel>> call, Response<List<YtbExtraTvModel>> response) {
                    ...
                    if (response.isSuccessful()) {
                        List<YtbExtraTvModel> data = response.body();
    ...
    private void updateUIWithCachedData(List<YtbExtraTvModel> cachedData) {
        if (cachedData != null && !cachedData.isEmpty()) {
            adapter = new YtbExtraTvAdapter(cachedData, YtbExtraTvLanguageDetailsActivity.this);
...
//        Intent intent = new Intent(YtbExtraTvLanguageDetailsActivity.this, YtbExtraTvYonlendirLanguageDetailsActivity.class);
//        startActivity(intent);
    }

    @Override
    public void onBackPressed() {
        Intent intent = new Intent(this, YtbExtraTvLanguageActivity.class);
        startActivity(intent);
        finish(); // Close the current activity
