...
public class TurkTvCategoriesDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_turk_tv_categories_details);
        ...
        homeButton.setOnClickListener(v -> {
            ...
            Intent homeIntent = new Intent(TurkTvCategoriesDetailsActivity.this, MainActivity.class);
...
//        Toast.makeText(this, "İnternet bağlantısı yok. Lütfen ağ ayarlarınızı kontrol edin.", Toast.LENGTH_LONG).show();
    ...
    public void onBackPressed() {
        Intent intent = new Intent(this, TurkTvCategoriesActivity.class);
        startActivity(intent);
        finish(); // Close the current activity
