...
public class EkstraTvActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ekstra_tv);
        ...
        if (actionBar != null) {
            actionBar.setTitle("Ekstra TV'ler");
        }
        ...
        AdView mAdView = findViewById(R.id.adViewTurkishLiveTv);
        AdRequest adRequest = new AdRequest.Builder().build();
        mAdView.loadAd(adRequest);

        /*
        ImageView closedBtn = findViewById(R.id.closeBtnTurkishLiveTv);
...
//        fetchData();
            ...
            public void onResponse(Call<List<UlusalTvModel>> call, Response<List<UlusalTvModel>> response) {
                if (response.isSuccessful()) {
                    ...
                    if (main_list != null && !main_list.isEmpty()) {
                        adapter = new UlusalTvAdapter(main_list, EkstraTvActivity.this);
    ...
    private void updateUIWithCachedData(List<UlusalTvModel> cachedData) {
        if (cachedData != null && !cachedData.isEmpty()) {
            adapter = new UlusalTvAdapter(cachedData, EkstraTvActivity.this);
            recyclerView.setAdapter(adapter);
        } else {
            handleNullResponse();
        }
...
//        Toast.makeText(this, "No internet connection. Please check your network settings.", Toast.LENGTH_LONG).show();
    ...
    private void redirectYonlendir() {
        ...
        Intent intent = new Intent(EkstraTvActivity.this, MainActivity.class);
            ...
            searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
                ...
                public boolean onQueryTextChange(String newText) {
                    ...
                    if (adapter != null) {
                        ...
                        adapter = new UlusalTvAdapter(myList, EkstraTvActivity.this);
                        recyclerView.setAdapter(adapter);
                    }
