...
public class YtbExtraTvYonlendirActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ytb_extra_tv_yonlendir);
        ...
        recyclerView = findViewById(R.id.extra_tv_big_slider_list);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        fetchData();

        AdView mAdView = findViewById(R.id.adViewExtraTvYonlendir);
        AdRequest adRequest = new AdRequest.Builder().build();
        mAdView.loadAd(adRequest);
        /*
        ImageView closedBtn = findViewById(R.id.closeBtnExtraTvYonlendir);
    ...
    private void fetchData() {
        Call<List<YtbExtraTvYonlendirModel>> req = ManagerAll.getInstance().ytbExtraTvYonlendirFetch();
            ...
            public void onResponse(Call<List<YtbExtraTvYonlendirModel>> call, Response<List<YtbExtraTvYonlendirModel>> response) {
                if (response.isSuccessful()) {
                    ...
                    if (main_list != null && !main_list.isEmpty()) {
                        adapter = new YtbExtraTvYonlendirAdapter(main_list, YtbExtraTvYonlendirActivity.this);
...
//        Toast.makeText(this, "No internet connection. Please check your network settings.", Toast.LENGTH_LONG).show();
    ...
    private void redirectYonlendir() {
        ...
        Intent intent = new Intent(YtbExtraTvYonlendirActivity.this, MainActivity.class);
        ...
        if (searchView != null) {
            ...
            queryTextListener = new SearchView.OnQueryTextListener() {
                ...
                public boolean onQueryTextChange(String newText) {
                    ...
                    List<YtbExtraTvYonlendirModel> myList = new ArrayList<>();

                    for (YtbExtraTvYonlendirModel model : main_list) {
