...
public class YtbExtraTvYonlendirCountriesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ytb_extra_tv_yonlendir_countries);
        ...
        homeButton.setOnClickListener(v -> {
            ...
            Intent homeIntent = new Intent(YtbExtraTvYonlendirCountriesActivity.this, MainActivity.class);
            startActivity(homeIntent);
            finish(); // Close the current activity
        });

        main_list = new ArrayList<>();
        recyclerView = findViewById(R.id.ytbExtraYonlendirCountriesRecyclerView);
            ...
            public void onResponse(Call<List<YtbExtraTvYonlendirCountryModel>> call, Response<List<YtbExtraTvYonlendirCountryModel>> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (main_list != null && !main_list.isEmpty()) {
                        adapter = new YtbExtraTvYonlendirCountryAdapter(main_list, YtbExtraTvYonlendirCountriesActivity.this);
...
//        Toast.makeText(this, "No internet connection. Please check your network settings.", Toast.LENGTH_LONG).show();
    ...
    private void redirectYonlendir() {
        ...
        Intent intent = new Intent(YtbExtraTvYonlendirCountriesActivity.this, MainActivity.class);
