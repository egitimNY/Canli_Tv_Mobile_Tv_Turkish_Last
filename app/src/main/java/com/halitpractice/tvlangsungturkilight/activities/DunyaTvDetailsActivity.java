...
public class DunyaTvDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dunya_tv_details);


        DunyaTvModel channel = (DunyaTvModel) getIntent().getSerializableExtra("channel");
        ...
        player.addListener(new Player.Listener() {
            ...
            public void onPlaybackStateChanged(int state) {
                if(state == Player.STATE_READY){
                    ...
                    Toast.makeText(DunyaTvDetailsActivity.this, "Şu an için TV kanalı yüklenemiyor, lütfen daha sonra tekrar deneyin!", Toast.LENGTH_LONG).show();
                    finish();
                    /*
