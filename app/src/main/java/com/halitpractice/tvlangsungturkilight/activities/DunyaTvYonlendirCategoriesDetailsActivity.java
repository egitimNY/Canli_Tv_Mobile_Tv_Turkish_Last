...
public class DunyaTvYonlendirCategoriesDetailsActivity extends AppCompatActivity {
    ...
    private void fetchData(String selectedCategory) {
        Call<List<DunyaTvYonlendirModel>> req = ManagerAll.getInstance().getDunyaTvByCategoryYonlendirFetch(selectedCategory);
            ...
            public void onResponse(Call<List<DunyaTvYonlendirModel>> call, Response<List<DunyaTvYonlendirModel>> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (main_list != null && !main_list.isEmpty()) {
                        adapter = new DunyaTvYonlendirAdapter(main_list, DunyaTvYonlendirCategoriesDetailsActivity.this);
