...
public class DunyaTvYonlendirCountriesDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        homeButton.setOnClickListener(v -> {
            ...
            Intent homeIntent = new Intent(DunyaTvYonlendirCountriesDetailsActivity.this, MainActivity.class);
            startActivity(homeIntent);
            finish(); // Close the current activity
        });

        recyclerView = findViewById(R.id.dunya_tv_countries_yonlendir_details_recycler); // Initialize the RecyclerView
        ...
        AdView mAdView = findViewById(R.id.adViewDunyaTvYonlendirCountriesDetails);
        AdRequest adRequest = new AdRequest.Builder().build();
        mAdView.loadAd(adRequest);

        ImageView closedBtn = findViewById(R.id.closeBtnDunyaTvYonlendirCountriesDetails);
...
//        Toast.makeText(this, "No internet connection. Please check your network settings.", Toast.LENGTH_LONG).show();
    ...
    private void redirectYonlendir() {
        ...
        Intent intent = new Intent(DunyaTvYonlendirCountriesDetailsActivity.this, MainActivity.class);
