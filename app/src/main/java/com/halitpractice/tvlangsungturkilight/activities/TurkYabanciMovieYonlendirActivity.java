...
public class TurkYabanciMovieYonlendirActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.yabanciMovieYonlendirRecycler);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));


        AdView mAdView = findViewById(R.id.adViewYabanciMovieYonlendir);
        AdRequest adRequest = new AdRequest.Builder().build();
        mAdView.loadAd(adRequest);

        /*
        ImageView closedBtn =findViewById(R.id.closeBtnYabanciMovieYonlendir);
    ...
    private void fetchData() {
        Call<List<TurkYabanciMovieYonlendirModel>> req = ManagerAll.getInstance().turkYabanciFilmYonlendir();
