...
public class DunyaTvCountriesDetailsActivity extends AppCompatActivity {
    ...
    private DunyaTvCountriesDetailsDataCache dataCache;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dunya_tv_countries_details);
        ...
        homeButton.setOnClickListener(v -> {
            ...
            Intent homeIntent = new Intent(DunyaTvCountriesDetailsActivity.this, MainActivity.class);
            startActivity(homeIntent);
            finish(); // Close the current activity
        });

        progressBar = findViewById(R.id.dunyaTvCountriesDetailsProgressBar); // Initialize the ProgressBar
        progressBar.setVisibility(View.GONE); // Initially, set it to VISIBLE

        recyclerView = findViewById(R.id.dunyaTvCountriesDetailsRecycler); // Initialize the RecyclerView
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        String selectedCategory = getIntent().getStringExtra("dunyaCountries");
        ...
        */
        ...
        AdView mAdView = findViewById(R.id.adViewDunyaTvCountriesDetails);
        AdRequest adRequest = new AdRequest.Builder().build();
        mAdView.loadAd(adRequest);

        ImageView closedBtn = findViewById(R.id.closeBtnDunyaTvCountriesDetails);
    ...
    private void fetchData(String selectedCategory) {
        ...
        if (cachedData != null && !cachedData.isEmpty()) {
            ...
            Call<List<YerelTvModel>> req = ManagerAll.getInstance().dunyaTvCountriesDetailsFetch(selectedCategory);
    ...
    private void updateUIWithCachedData(List<YerelTvModel> cachedData) {
        if (cachedData != null && !cachedData.isEmpty()) {
            adapter = new YerelTvAdapter(cachedData, DunyaTvCountriesDetailsActivity.this);
...
//        Toast.makeText(this, "İnternet bağlantısı yok. Lütfen ağ ayarlarınızı kontrol edin.", Toast.LENGTH_LONG).show();
    ...
    public void onBackPressed() {
        Intent intent = new Intent(this, DunyaTvCountriesActivity.class);
        startActivity(intent);
        finish(); // Close the current activity
