...
import com.halitpractice.tvlangsungturkilight.adapters.DunyaTvYonlendirLanguageAdapter;
...
public class DunyaTvYonlendirLanguageActivity extends AppCompatActivity {

    private RecyclerView recyclerView;
    private List<DunyaTvYonlendirLanguageModel> main_list;
    private DunyaTvYonlendirLanguageAdapter adapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dunya_tv_yonlendir_language);
        ...
        homeButton.setOnClickListener(v -> {
            ...
            Intent homeIntent = new Intent(DunyaTvYonlendirLanguageActivity.this, MainActivity.class);
            startActivity(homeIntent);
            finish(); // Close the current activity
        });

        main_list = new ArrayList<>();
        recyclerView = findViewById(R.id.worldTvYonlendirLanguageRecyclerView);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        AdView mAdView = findViewById(R.id.adViewWorldTvYonlendirLanguage);
        AdRequest adRequest = new AdRequest.Builder().build();
        mAdView.loadAd(adRequest);
        /*
        ImageView closedBtn = findViewById(R.id.closeBtnWorldTvYonlendirLanguage);
    ...
    private void fetchData() {
        ...
        Call<List<DunyaTvYonlendirLanguageModel>> req = ManagerAll.getInstance().dunyaTvLanguageYonlendirFetch();
        req.enqueue(new Callback<List<DunyaTvYonlendirLanguageModel>>() {
            @Override
            public void onResponse(Call<List<DunyaTvYonlendirLanguageModel>> call, Response<List<DunyaTvYonlendirLanguageModel>> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (main_list != null && !main_list.isEmpty()) {
                        adapter = new DunyaTvYonlendirLanguageAdapter(main_list, DunyaTvYonlendirLanguageActivity.this);
            ...
            @Override
            public void onFailure(Call<List<DunyaTvYonlendirLanguageModel>> call, Throwable t) {
...
//            Toast.makeText(this, "There is no internet connection. Please check your network settings.", Toast.LENGTH_LONG).show();
    ...
    private void redirectYonlendir() {
        ...
        Intent intent = new Intent(DunyaTvYonlendirLanguageActivity.this, MainActivity.class);
