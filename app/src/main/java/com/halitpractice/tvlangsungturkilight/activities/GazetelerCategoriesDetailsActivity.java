...
public class GazetelerCategoriesDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gazeteler_categories_details);
        ...
        progressBar = findViewById(R.id.progressBarGazetelerCategoriesDetails); // Initialize the ProgressBar
        progressBar.setVisibility(View.GONE); // Initially, set it to GONE

        ImageView homeButton = findViewById(R.id.homeButton);
        homeButton.setOnClickListener(v -> {
            // Handle the home button click here
            Intent homeIntent = new Intent(GazetelerCategoriesDetailsActivity.this, MainActivity.class);
            startActivity(homeIntent);
            finish(); // Close the current activity
        });

        recyclerView = findViewById(R.id.gazetelerCategoriesDetailsRecyclerView); // Initialize the RecyclerView
        ...
        AdView mAdView = findViewById(R.id.adViewGazetelerDetailsCategories);
        AdRequest adRequest = new AdRequest.Builder().build();
        mAdView.loadAd(adRequest);

        /*
        ImageView closedBtn = findViewById(R.id.closeBtnGazetelerCategoriesDetails);
    ...
    private void fetchData(String selectedCategory) {
        ...
        Call<List<GazetelerModel>> req = ManagerAll.getInstance().gazetelerCategoryDetailsFetch(selectedCategory);
            ...
            public void onResponse(Call<List<GazetelerModel>> call, Response<List<GazetelerModel>> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (main_list != null && !main_list.isEmpty()) {
                        adapter = new GazetelerAdapter(main_list, GazetelerCategoriesDetailsActivity.this);
...
//            Toast.makeText(this, "There is no internet connection. Please check your network settings.", Toast.LENGTH_LONG).show();
    ...
    private void redirectYonlendir() {
        ...
        Intent intent = new Intent(GazetelerCategoriesDetailsActivity.this, MainActivity.class);
    ...
    public void onBackPressed() {
        Intent intent = new Intent(this, GazetelerCategoriesActivity.class);
        startActivity(intent);
        finish(); // Close the current activity
