...
import com.halitpractice.tvlangsungturkilight.adapters.GazetelerCountryAdapter;
...
public class GazetelerCountriesActivity extends AppCompatActivity {

    private RecyclerView recyclerView;
    private List<GazetelerCountryModel> main_list;
    private GazetelerCountryAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gazeteler_countries);
        ...
        progressBar = findViewById(R.id.progressBarGazetelerCountries); // Initialize the ProgressBar
        progressBar.setVisibility(View.GONE); // Initially, set it to GONE

        ImageView homeButton = findViewById(R.id.homeButton);
        homeButton.setOnClickListener(v -> {
            // Handle the home button click here
            Intent homeIntent = new Intent(GazetelerCountriesActivity.this, MainActivity.class);
            startActivity(homeIntent);
            finish(); // Close the current activity
        });

        main_list = new ArrayList<>();
        recyclerView = findViewById(R.id.gazetelerCountriesRecyclerView);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        AdView mAdView = findViewById(R.id.adViewGazetelerCountries);
        AdRequest adRequest = new AdRequest.Builder().build();
        mAdView.loadAd(adRequest);

        /*
        ImageView closedBtn = findViewById(R.id.closeBtnGazetelerCountries);
    ...
    private void fetchData() {
        ...
        Call<List<GazetelerCountryModel>> req = ManagerAll.getInstance().gazetelerCountryFetch();
        req.enqueue(new Callback<List<GazetelerCountryModel>>() {
            @Override
            public void onResponse(Call<List<GazetelerCountryModel>> call, Response<List<GazetelerCountryModel>> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (main_list != null && !main_list.isEmpty()) {
                        adapter = new GazetelerCountryAdapter(main_list, GazetelerCountriesActivity.this);
            ...
            @Override
            public void onFailure(Call<List<GazetelerCountryModel>> call, Throwable t) {
...
//            Toast.makeText(this, "There is no internet connection. Please check your network settings.", Toast.LENGTH_LONG).show();
    ...
    private void redirectYonlendir() {
        ...
        Intent intent = new Intent(GazetelerCountriesActivity.this, MainActivity.class);
