...
import com.halitpractice.tvlangsungturkilight.services.DunyaTvCategoriesDetailsDataCache;
...
public class DunyaTvCategoriesDetailsActivity extends AppCompatActivity {
    ...
    private DunyaTvCategoriesDetailsDataCache dataCache;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dunya_tv_categories_details);
        ...
        homeButton.setOnClickListener(v -> {
            ...
            Intent homeIntent = new Intent(DunyaTvCategoriesDetailsActivity.this, MainActivity.class);
            startActivity(homeIntent);
            finish(); // Close the current activity
        });

        progressBar = findViewById(R.id.dunyaTvCategoryDetailsProgressBar); // Initialize the ProgressBar
        progressBar.setVisibility(View.GONE); // Initially, set it to VISIBLE

        recyclerView = findViewById(R.id.dunyaTvCategoryDetailsRecycler); // Initialize the RecyclerView
        ...
        */
        ...
        dataCache = DunyaTvCategoriesDetailsDataCache.getInstance();
        ...
        AdView mAdView = findViewById(R.id.adViewDunyaTvCategoriesDetails);
        AdRequest adRequest = new AdRequest.Builder().build();
        mAdView.loadAd(adRequest);

        /*
        ImageView closedBtn = findViewById(R.id.closeBtnDunyaTvCategoriesDetails);
    ...
    private void fetchData(String selectedCategory) {
        ...
        if (cachedData != null && !cachedData.isEmpty()) {
            ...
            Call<List<DunyaTvModel>> req = ManagerAll.getInstance().dunyaTvCategoryDetailsFetch(selectedCategory);
    ...
    private void updateUIWithCachedData(List<DunyaTvModel> cachedData) {
        if (cachedData != null && !cachedData.isEmpty()) {
            adapter = new DunyaTvAdapter(cachedData, DunyaTvCategoriesDetailsActivity.this);
...
//        Toast.makeText(this, "İnternet bağlantısı yok. Lütfen ağ ayarlarınızı kontrol edin.", Toast.LENGTH_LONG).show();
    ...
    public void onBackPressed() {
        Intent intent = new Intent(this, DunyaTvCategoriesActivity.class);
        startActivity(intent);
        finish(); // Close the current activity
