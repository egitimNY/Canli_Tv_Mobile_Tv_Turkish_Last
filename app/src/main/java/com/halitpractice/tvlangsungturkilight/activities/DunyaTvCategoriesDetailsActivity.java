...
public class DunyaTvCategoriesDetailsActivity extends AppCompatActivity {
    ...
    private void fetchData(String selectedCategory) {
        ...
        if (cachedData != null && !cachedData.isEmpty()) {
            ...
            Call<List<YerelTvModel>> req = ManagerAll.getInstance().dunyaTvCategoryDetailsFetch(selectedCategory);
    ...
    private void updateUIWithCachedData(List<YerelTvModel> cachedData) {
        if (cachedData != null && !cachedData.isEmpty()) {
            adapter = new YerelTvAdapter(cachedData, DunyaTvCategoriesDetailsActivity.this);
