...
import com.halitpractice.tvlangsungturkilight.adapters.YtbExtraTvYonlendirCategoryAdapter;
...
public class YtbExtraTvYonlendirCategoriesActivity extends AppCompatActivity {

    private RecyclerView recyclerView;
    private List<YtbExtraTvYonlendirCategoryModel> main_list;
    private YtbExtraTvYonlendirCategoryAdapter adapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ytb_extra_tv_yonlendir_categories);
    ...
    private void fetchData() {
        ...
        Call<List<YtbExtraTvYonlendirCategoryModel>> req = ManagerAll.getInstance().ytbExtraTvCategoryYonlendirFetch();
            ...
            public void onResponse(Call<List<YtbExtraTvYonlendirCategoryModel>> call, Response<List<YtbExtraTvYonlendirCategoryModel>> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (main_list != null && !main_list.isEmpty()) {
                        adapter = new YtbExtraTvYonlendirCategoryAdapter(main_list, YtbExtraTvYonlendirCategoriesActivity.this);
...
//        Toast.makeText(this, "No internet connection. Please check your network settings.", Toast.LENGTH_LONG).show();
    ...
    private void redirectYonlendir() {
        ...
        Intent intent = new Intent(YtbExtraTvYonlendirCategoriesActivity.this, MainActivity.class);
